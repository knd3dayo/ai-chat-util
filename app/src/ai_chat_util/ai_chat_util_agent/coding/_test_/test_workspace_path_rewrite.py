...
from ai_chat_util.ai_chat_util_agent.coding._api_.api_server import create_app
...
def test_http_execute_applies_rewrite_and_persists_metadata(tmp_path: Path, monkeypatch) -> None:
    ...
    from ai_chat_util.ai_chat_util_agent.coding.core import endpoint as endpoint_mod
    from ai_chat_util.ai_chat_util_agent.coding.core import task_manager as tm_mod
