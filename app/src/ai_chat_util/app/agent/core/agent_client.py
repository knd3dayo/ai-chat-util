...
from ai_chat_util.core.chat.model import ChatRequest, ChatResponse, ChatMessage, ChatContent, ChatHistory, ChatRequestContext, HitlRequest
...
from ai_chat_util.core.common.config.runtime import get_runtime_config, AiChatUtilConfig, CodingAgentUtilConfig
from ai_chat_util.core.chat import LLMMessageContentFactoryBase, LLMMessageContentFactory
...
if TYPE_CHECKING:
    from ai_chat_util.app.workflow.chat_client import WorkflowChatClient as WorkflowChatClientType
...
def _get_workflow_chat_client_class() -> type[WorkflowChatClientType] | Any:
    ...
    if WorkflowChatClient is None:
        from ai_chat_util.app.workflow.chat_client import WorkflowChatClient as ImportedWorkflowChatClient
