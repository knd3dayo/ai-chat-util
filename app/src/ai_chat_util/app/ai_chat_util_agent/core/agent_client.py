...
if TYPE_CHECKING:
    from ai_chat_util.app.ai_chat_util_workflow.chat_client import WorkflowChatClient as WorkflowChatClientType
...
def _get_workflow_chat_client_class() -> type[WorkflowChatClientType] | Any:
    ...
    if WorkflowChatClient is None:
        from ai_chat_util.app.ai_chat_util_workflow.chat_client import WorkflowChatClient as ImportedWorkflowChatClient
