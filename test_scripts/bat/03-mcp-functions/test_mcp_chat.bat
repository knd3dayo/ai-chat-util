...
uv --directory "%UV_PROJECT_DIR%" run -m ai_chat_util.cli --config "%AI_CHAT_UTIL_CONFIG%" --loglevel DEBUG --logfile chat_timeout_5s.log chat --use_mcp -p "C:\Users\user\source\repos\util\ai-chat-util\work\test\data\test.pngを分析してください。"
exit /b %errorlevel%
